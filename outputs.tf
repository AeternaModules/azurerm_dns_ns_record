...
output "dns_ns_records_records" {
  ...
  value       = { for k, v in azurerm_dns_ns_record.dns_ns_records : k => v.records }
}
...
output "dns_ns_records_zone_name" {
  ...
  value       = { for k, v in azurerm_dns_ns_record.dns_ns_records : k => v.zone_name }
}
